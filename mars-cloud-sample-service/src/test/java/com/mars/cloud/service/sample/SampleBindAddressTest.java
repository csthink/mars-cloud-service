...
/**
 * 示例服务的业务端口、管理端口与注册到 Nacos 的地址都取 {@code SERVER_ADDRESS}，缺省为回环地址。
 *
...
class SampleBindAddressTest {
    ...
    private static Map<String, String> resolveAddresses(Map<String, Object> variables) throws IOException {
        ...
        new YamlPropertySourceLoader()
                .load("sample-configuration", new ClassPathResource("config/application.yml"))
